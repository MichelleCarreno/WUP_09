...
The date for the Adjusted Square has a best model for length 1. We can determine this summary has a p-value of 2.2e-16. 
...
Using the chart above, we can see that the best two regressor models are Height and weight. This model is the best for the perch data, as well for the two element model. 
